...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			for (BeanFactoryPostProcessor postProcessor : beanFactoryPostProcessors) {
				/*
					判断是不是属于BeanFactoryPostProcessor的子类BeanDefinitionRegistryPostProcessor
					作为BeanFactoryPostProcessor的子类的BeanDefinitionRegistryPostProcessor功能肯定更强
				 */
	...
	public static void registerBeanPostProcessors(
		...
		/*
			beanFactory.getBeanPostProcessorCount()获取beanFactory中已经含有的BeanPostProcessor的个数
			初始化的时候spring自己放进去的
		 */
		int beanProcessorTargetCount = beanFactory.getBeanPostProcessorCount() + 1 + postProcessorNames.length;
		//这个BeanPostProcessorChecker主要是负责检查的
